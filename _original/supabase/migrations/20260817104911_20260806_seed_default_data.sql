...
2. shipping_rates
- standard, express, sameday courier tiers (later deactivated in favor of local-only).
3. coupons
...
-- Shipping rates (initial; later simplified to local-only)
...
-- Deactivate old courier options, upsert single local delivery option
