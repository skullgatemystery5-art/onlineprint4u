...
1. pricing_rates — 16 print-per-page rows, 5 binding rows, add-on rows.
2. shipping_rates — local delivery (Patna only), old tiers deactivated.
3. coupons — WELCOME50, PRINT10.
4. reviews — 6 default customer testimonials.
